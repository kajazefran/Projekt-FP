...
Kot reprezentativen primer si oglejmo primer $n = 60$.
Rezultati, prikazani v Tabeli 2, kažejo, da Somborjev indeks za vse obravnavane vrednosti parametra $\alpha$
monotono narašča z naraščanjem maksimalne stopnje $\Delta$.

\medskip

Opazimo, da se z večanjem parametra $\alpha$ razlike med vrednostmi Somborjevega indeksa pri različnih $\Delta$ še povečujejo.
To pomeni, da večje vrednosti $\alpha$ dodatno poudarijo prispevek povezav, ki povezujejo vozlišča z visokimi stopnjami,
kar je posebej izrazito pri ekstremno razvejanih drevesih, kot je zvezdno drevo.
...
Kot pri manjših grafih je globalni maksimum Somborjevega indeksa dosežen pri $\Delta = n-1$, 
kar ustreza zvezdnemu drevesu z enim dominantnim vozliščem. To potrjuje, da tudi pri večjih drevesih
ekstremno razvejane strukture ostajajo optimalne glede na Somborjev indeks.
