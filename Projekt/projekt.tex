...
Eden izmed takšnih indeksov je \emph{splošni Somborjev indeks}.
...
V tem delu raziskave se omejimo na \emph{drevesa}, saj ta predstavljajo osnovni, a hkrati dovolj raznolik razred grafov,
...
Analiza Somborjevega indeksa je bila izvedena z uporabo dveh različnih računskih pristopov, odvisno od velikosti 
...
Za vsako drevo smo izračunali največjo stopnjo $\Delta$ ter vrednost $\alpha$-Somborjevega indeksa za izbrane vrednosti parametra
\[
\alpha \in \{0.05, 0.45, 0.5, 0.55, 0.95\}.
\]
...
Algoritem začne z naključno izbranim drevesom in izvaja zaporedne lokalne spremembe strukture (npr.\ prevezave robov), pri 
čemer se ohrani lastnost, da je graf drevo. Vsaka sprememba je sprejeta le, če poveča vrednost Somborjevega indeksa.
